...
<section class="donate py-5">
    <div class="container">
        <div class="row text-center">
            <div class="col-12">
                <h1>Donate to the Kingdom of God through
Rapha Word Church</h1>
...
<p>Donate through ZELLE using the following email: admin@raphaword.org</p>
<p></p>
			 		  </div>
		</div>	
		  <div class="col-sm-6 col-md-4">
...
<p>The most traditional way we give. Simply place your offering in the offering basket in the sanctuary (540 W Harwood Rd, Hurst, TX 76054).</p>
<p></p>
			 		  </div>
		</div>	
		  <div class="col-sm-6 col-md-4">
...
<p>If you choose to donate via CashApp, please use the following CashApp ID $RaphaWordDFW</p>
<p></p>
			 		  </div>
		</div>	
		  <div class="col-sm-6 col-md-4">
...
<p>You may mail your donation to Rapha Word Church 540 W Harwood Rd Hurst TX 76054 Make your donation check to: Rapha Word International Ministry</p>
<p></p>
			 		  </div>
		</div>	
