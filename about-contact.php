  ...
  <div class="container">
    ...
    <div class="col-md-9" id="mission">
      <div class="tab-content">
        <h2>CONTACT US</h2>
        <p class="mail-text"><strong>E-mail: info@thegreaterworksministry.org</strong></p>
        <p>If you’d like to join our mailing list where we send empowerment and updates fill out the form share with us you’d like to join our e-mail list or send an e-mail to info@thegreaterworksministry.org.</p>
